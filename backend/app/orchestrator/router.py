...
async def route_query(
    ...
    system_prompt = (
        ...
        "1. 'rag': The query asks about a specific named product, proprietary software, internal tool, "
        "company, or brand (e.g. AcmeCRM, Stripe, Notion, Slack) — especially anything that would "
        "only be answerable by looking up stored documentation. Also choose 'rag' for queries about "
        "screenshots, console logs, or visual artifacts from a specific application.\n"
        "2. 'direct': General knowledge, chit-chat, greetings, or generic questions about "
        "well-known programming languages (Python, JavaScript, SQL, etc.), standard algorithms, "
        "math, geography, or any topic fully answerable from broad world knowledge with no need "
        "for a product-specific document lookup.\n"
        "3. 'web_search': Queries about current events, real-time facts, live news, sports scores, "
        "or information that changes over time and requires live internet access.\n"
